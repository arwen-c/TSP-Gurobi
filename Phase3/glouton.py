...
def optiGlouton(capacite, distance, duree, debut, fin, nbreTaches, employeesDico, indispoDico, tachesDico):
    ...
    for n in range(nombreEmploye):
        ...
        while newTachePossible:  # on construit la journée d'un employé au fur et à mesure
            ...
            raison, tache, creneau = tachesRealisables(tachesOpti, duree, debut, fin, recuperationHeure(
                employe['WorkingEndTime']), indispoDicoEmployeN, t, pauseFaite, localisationCourante, distance, tachesDico, n, nbreTaches)  # rôle à bien définir
            print(t)
            print(raison)
            print(tache)
