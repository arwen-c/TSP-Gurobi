...
from usefulFunctions3 import extractionData
#import folium
...
def creation_listes(nom_ville):
    ...
    filename = "Phase3/Solutions/Solution"+str(nom_ville)+"V2ByV3.txt"
...
def afficher(nom_ville):
    ...
    path2 = "Phase3/Solutions/Solution"+str(nom_ville)+"V2ByV3.txt"
